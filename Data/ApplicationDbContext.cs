    ...
    public class ApplicationDbContext : ApiAuthorizationDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Course>().HasData(
                ...
                new Course { Id = 20, Type = "online", Name = "Carnegie Mellon Open Learning", Category = "all", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = true, HighSchool = true, HigherEducation = true, WebSite = "http://oli.cmu.edu/independent-learner-courses/" },
                new Course { Id = 21, Type = "online", Name = "MIT Open Courseware", Category = "all", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = true, HighSchool = true, HigherEducation = true, WebSite = "https://ocw.mit.edu/index.htm" },
                ...
                new Course { Id = 24, Type = "online", Name = "Harvard extension School", Category = "all", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = true, HigherEducation = true, WebSite = "https://www.extension.harvard.edu/open-learning-initiative" },
                ...
                new Course { Id = 8, Type = "books", Name = "Son light", Category = "all", Resource = true, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "https://www.sonlight.com/" },
                ...
                new Course { Id = 1, Type = "link", Name = "Oxford Podcasts", Category = "all", Resource = true, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "http://podcasts.ox.ac.uk/series" },
                new Course { Id = 10, Type = "link", Name = "Hacking STEM Library", Category = "all", Resource = true, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "https://www.microsoft.com/en-us/education/education-workshop/activity-library.aspx" },
                new Course { Id = 11, Type = "link", Name = "Texas Home School Coalition", Category = "all", Resource = true, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "https://thsc.org/" },
                ...
                new Course { Id = 14, Type = "link", Name = "code academy", Category = "all", Resource = true, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "https://www.codecademy.com/" },
                ...
                new Course { Id = 2, Type = "online", Name = "Why Ville", Category = "all", Resource = true, PreSchool = true, Elementary = true, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "http://www.whyville.net/smmk/nice" },
                new Course { Id = 3, Type = "online", Name = "Fun brain", Category = "all", Resource = true, PreSchool = true, Elementary = true, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "https://www.funbrain.com/" },
                ...
                new Course { Id = 33, Type = "online", Name = "edX English Grammar & Style", Category = "english", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = true, HighSchool = true, HigherEducation = true, WebSite = "https://www.edx.org/course/english-grammar-and-style" },
                ...
                new Course { Id = 31, Type = "online", Name = "Old Fashioned Education Science & Nature", Category = "science", Resource = false, PreSchool = true, Elementary = true, MiddleSchool = true, HighSchool = false, HigherEducation = false, WebSite = "http://oldfashionededucation.com/science.htm" },
                ...
                new Course { Id = 26, Type = "link", Name = "Mem Rise", Category = "english", Resource = true, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "https://www.memrise.com/" },
                ...
                new Course { Id = 45, Type = "online", Name = "Khan Academy Pre-Algebra", Category = "math", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = true, HighSchool = true, HigherEducation = false, WebSite = "https://www.khanacademy.org/math/pre-algebra" },
                ...
                new Course { Id = 46, Type = "online", Name = "edX Math Essentials", Category = "math", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = true, HigherEducation = true, WebSite = "https://www.edx.org/course/maths-essentials" },
                ...
                new Course { Id = 39, Type = "books", Name = "Apologia math", Category = "math", Resource = true, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "https://www.apologia.com/" },
                new Course { Id = 40, Type = "books", Name = "Miquon math", Category = "math", Resource = true, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "https://miquonmath.com/" },
                ...
                new Course { Id = 55, Type = "app", Name = "C++ Programming by WAG mob", Category = "science", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = true, HighSchool = true, HigherEducation = true, WebSite = "https://www.microsoft.com/en-us/p/c-programming-by-wagmob/9wzdncrdn96h?activetab=pivot:overviewtab" },
                new Course { Id = 56, Type = "app", Name = "Chemistry by WAG mob", Category = "science", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = true, HighSchool = true, HigherEducation = true, WebSite = "https://www.microsoft.com/en-us/p/chemistry-by-wagmob/9wzdncrdn317?activetab=pivot:overviewtab" },
                ...
                new Course { Id = 59, Type = "online", Name = "edX Applied Human Anatomy", Category = "science", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = true, HigherEducation = true, WebSite = "https://www.edx.org/course/applied-anatomy-of-the-locomotor-system" },
                ...
                new Course { Id = 52, Type = "books", Name = "Apologia science", Category = "science", Resource = true, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "https://www.apologia.com/" },
                ...
                new Course { Id = 69, Type = "online", Name = "Khan Academy US Government & Civics", Category = "socialstudies", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = true, HighSchool = true, HigherEducation = false, WebSite = "https://www.khanacademy.org/humanities/us-government-and-civics" },
                new Course { Id = 72, Type = "online", Name = "Khan Academy Ap World History", Category = "socialstudies", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = true, HigherEducation = false, WebSite = "https://www.khanacademy.org/humanities/ap-world-history" },
                new Course { Id = 67, Type = "online", Name = "Coursera Economics of Money", Category = "socialstudies", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = true, HighSchool = true, HigherEducation = true, WebSite = "https://www.coursera.org/learn/money-banking" },
                new Course { Id = 68, Type = "online", Name = "Hillsdale College Free Courses", Category = "socialstudies", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = true, HighSchool = true, HigherEducation = true, WebSite = "https://www.hillsdale.edu/educational-outreach/free-online-courses/" },
                new Course { Id = 70, Type = "online", Name = "edX Introduction to American Government", Category = "socialstudies", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = true, HigherEducation = true, WebSite = "https://www.edx.org/xseries/harvardx-us-government" },
                new Course { Id = 71, Type = "online", Name = "Udemy Psychology", Category = "socialstudies", Resource = false, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = true, HigherEducation = true, WebSite = "https://www.udemy.com/topic/social-psychology/" },
                new Course { Id = 66, Type = "online", Name = "Khan Academy US History", Category = "socialstudies", Resource = false, PreSchool = false, Elementary = true, MiddleSchool = true, HighSchool = true, HigherEducation = false, WebSite = "https://www.khanacademy.org/humanities/us-history" },
                new Course { Id = 65, Type = "online", Name = "Old Fashioned Education Geography", Category = "socialstudies", Resource = false, PreSchool = true, Elementary = true, MiddleSchool = true, HighSchool = false, HigherEducation = false, WebSite = "http://oldfashionededucation.com/geography.htm" },
                new Course { Id = 63, Type = "books", Name = "Apologia social studies", Category = "socialstudies", Resource = true, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "https://www.apologia.com/" },
                new Course { Id = 64, Type = "books", Name = "Beautiful Feet Books", Category = "socialstudies", Resource = true, PreSchool = false, Elementary = false, MiddleSchool = false, HighSchool = false, HigherEducation = false, WebSite = "http://www.bfbooks.com/" }
                );
